  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <ul>
        ...
        <li>
          <a href="/static/pdf/Tract générique A5.pdf"><i class="fa fa-file-pdf pr-2"></i>Tract générique A5</a>
        </li>
      ...
      <div class="visuels">
        ...
        <img class="image" src="/static/images/photos/Patrimoine/IMG_8935.jpg" alt="">
        <img class="image" src="/static/images/photos/Patrimoine/IMG_8945.jpg" alt="">
      </div>
<!-- 
      <h2 class="title is-3">Reportages en photos des mobilisations</h2>

      <div class="visuels">
        <img class="image" src="/static/images/photos/Eclairage Nocture du Kiosque.jpg" alt="">
      </div>
 -->
    </div>
  </div>
